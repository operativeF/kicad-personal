...
void DIALOG_PRINT_USING_PRINTER::InitValues( )
{
    ...
    if( m_Config )
    {
        ...
        m_Config->Read( OPTKEY_PRINT_PAGE_FRAME, &s_Parameters.m_Print_Sheet_Ref, true );
        m_Config->Read( OPTKEY_PRINT_MONOCHROME_MODE, &s_Parameters.m_Print_Black_and_White, true );
